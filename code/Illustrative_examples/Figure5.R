...
load("./sim3_set1_d100T100K50.RData"); r_hat_c1_d100T100K50 <- na.omit(r_hat)
load("./sim3_set2_d100T100K50.RData"); r_hat_c2_d100T100K50 <- na.omit(r_hat)
load("./sim3_set3_d100T100K50.RData"); r_hat_c3_d100T100K50 <- na.omit(r_hat)
load("./sim3_set4_d100T100K50.RData"); r_hat_c4_d100T100K50 <- na.omit(r_hat)
load("./sim3_set5_d100T100K50.RData"); r_hat_c5_d100T100K50 <- na.omit(r_hat)
load("./sim3_set6_d100T100K50.RData"); r_hat_c6_d100T100K50 <- na.omit(r_hat)
...
load("./sim3_set1_d200T100K50.RData"); r_hat_c1_d200T100K50 <- na.omit(r_hat)
load("./sim3_set2_d200T100K50.RData"); r_hat_c2_d200T100K50 <- na.omit(r_hat)
load("./sim3_set3_d200T100K50.RData"); r_hat_c3_d200T100K50 <- na.omit(r_hat)
load("./sim3_set4_d200T100K50.RData"); r_hat_c4_d200T100K50 <- na.omit(r_hat)
load("./sim3_set5_d200T100K50.RData"); r_hat_c5_d200T100K50 <- na.omit(r_hat)
load("./sim3_set6_d200T100K50.RData"); r_hat_c6_d200T100K50 <- na.omit(r_hat)
...
load("./sim3_set1_d300T100K50.RData"); r_hat_c1_d300T100K50 <- na.omit(r_hat)
load("./sim3_set2_d300T100K50.RData"); r_hat_c2_d300T100K50 <- na.omit(r_hat)
load("./sim3_set3_d300T100K50.RData"); r_hat_c3_d300T100K50 <- na.omit(r_hat)
load("./sim3_set4_d300T100K50.RData"); r_hat_c4_d300T100K50 <- na.omit(r_hat)
load("./sim3_set5_d300T100K50.RData"); r_hat_c5_d300T100K50 <- na.omit(r_hat)
load("./sim3_set6_d300T100K50.RData"); r_hat_c6_d300T100K50 <- na.omit(r_hat)
...
load("./sim3_set1_d100T200K50.RData"); r_hat_c1_d100T200K50 <- na.omit(r_hat)
load("./sim3_set2_d100T200K50.RData"); r_hat_c2_d100T200K50 <- na.omit(r_hat)
load("./sim3_set3_d100T200K50.RData"); r_hat_c3_d100T200K50 <- na.omit(r_hat)
load("./sim3_set4_d100T200K50.RData"); r_hat_c4_d100T200K50 <- na.omit(r_hat)
load("./sim3_set5_d100T200K50.RData"); r_hat_c5_d100T200K50 <- na.omit(r_hat)
load("./sim3_set6_d100T200K50.RData"); r_hat_c6_d100T200K50 <- na.omit(r_hat)
...
load("./sim3_set1_d100T300K50.RData"); r_hat_c1_d100T300K50 <- na.omit(r_hat)
load("./sim3_set2_d100T300K50.RData"); r_hat_c2_d100T300K50 <- na.omit(r_hat)
load("./sim3_set3_d100T300K50.RData"); r_hat_c3_d100T300K50 <- na.omit(r_hat)
load("./sim3_set4_d100T300K50.RData"); r_hat_c4_d100T300K50 <- na.omit(r_hat)
load("./sim3_set5_d100T300K50.RData"); r_hat_c5_d100T300K50 <- na.omit(r_hat)
load("./sim3_set6_d100T300K50.RData"); r_hat_c6_d100T300K50 <- na.omit(r_hat)
