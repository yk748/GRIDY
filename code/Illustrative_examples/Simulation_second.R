#-----------------------------------------------------------------------------#
# Code for producing results for the second simulation setting in Illustrative example section
# Codes for plotting Figures 3 and 4 are provided separately
#-----------------------------------------------------------------------------#
...
for (case in 1:6){
  ...
  for (set in 1:2){
    ...
    for (iter in 1:max_iter){
      ...
      file_name <- paste0("sim2_snr",case,"_type",set,".RData")
